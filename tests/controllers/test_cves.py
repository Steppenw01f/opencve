...
@pytest.mark.parametrize(
    ...
    [
        ({"sort": "cve"},
         ["CVE-2020-9392", "CVE-2020-35076", "CVE-2020-29660", "CVE-2020-26116", "CVE-2019-17052", "CVE-2018-18074"]
         ),
        ...
        ({"sort": ["cve_asc"]},
         ["CVE-2018-18074", "CVE-2019-17052", "CVE-2020-26116", "CVE-2020-29660", "CVE-2020-35076", "CVE-2020-9392"]
         ),

        ({"sort": ["updated"]},
         ['CVE-2020-26116', 'CVE-2019-17052', 'CVE-2018-18074', 'CVE-2020-29660', 'CVE-2020-35076', 'CVE-2020-9392']
         ),

        ({"sort": ["updated_asc"]},
         ['CVE-2020-9392', 'CVE-2020-35076', 'CVE-2020-29660', 'CVE-2018-18074', 'CVE-2019-17052', 'CVE-2020-26116']
         ),

        ({"sort": ["published"]},
         ['CVE-2020-35076', 'CVE-2020-29660', 'CVE-2020-26116', 'CVE-2020-9392', 'CVE-2019-17052', 'CVE-2018-18074']
         ),

        ({"sort": ["published_asc"]},
         ["CVE-2018-18074", "CVE-2019-17052", "CVE-2020-9392", "CVE-2020-26116", "CVE-2020-29660", "CVE-2020-35076"]
         ),

        ({"sort": ["cvss2"]},
         ['CVE-2020-9392', 'CVE-2020-26116', 'CVE-2018-18074', 'CVE-2020-29660', 'CVE-2019-17052', 'CVE-2020-35076']
         ),

        ({"sort": ["cvss2_asc"]},
         ['CVE-2019-17052', 'CVE-2020-29660', 'CVE-2018-18074', 'CVE-2020-26116', 'CVE-2020-9392', 'CVE-2020-35076']
         ),

        ({"sort": ["cvss3"]},
         ['CVE-2019-17052', 'CVE-2020-29660', 'CVE-2020-26116', 'CVE-2020-9392', 'CVE-2018-18074', 'CVE-2020-35076']
         ),

        ({"sort": ["cvss3_asc"]},
         ['CVE-2018-18074', 'CVE-2020-9392', 'CVE-2020-26116', 'CVE-2020-29660', 'CVE-2019-17052', 'CVE-2020-35076']
         ),

        ({"sort": ["cvss2", "cvss3_asc"]},
         ['CVE-2020-9392', 'CVE-2020-26116', 'CVE-2018-18074', 'CVE-2019-17052', 'CVE-2020-29660', 'CVE-2020-35076']
         ),
    ],
)
def test_list_cves_sorted(app, create_cves, args, result):
    create_cves(
        [
            "CVE-2018-18074",
            "CVE-2020-9392",
    ...
    with app.test_request_context():
        cves = CveController.list_items(args)
    assert [cve.cve_id for cve in cves] == result
